...
// ==========================================================
//  Copyright Reserved Omar Hamid (Foods)
// ==========================================================
define('MB',1048579);
...
function imageUpload($imageRequest) {
   ...
   $allowExt    = array("jpg","png","jpeg","gif","mp3","pdf","mp4","docx","mdb","accdb");
...
function deleteFile($dir , $imagename){
 ...
 function printflailure($message="none"){
